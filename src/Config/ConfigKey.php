...
abstract class ConfigKey
{
    ...
    public const CORE_AGENT_LOG_LEVEL        = 'agent_log_level';
    public const CORE_AGENT_LOG_FILE         = 'log_file';
    public const CORE_AGENT_CONFIG_FILE      = 'config_file';
    public const CORE_AGENT_SOCKET_PATH      = 'socket_path';
    public const CORE_AGENT_DIRECTORY        = 'core_agent_dir';
    public const CORE_AGENT_FULL_NAME        = 'core_agent_full_name';
    public const CORE_AGENT_DOWNLOAD_URL     = 'download_url';

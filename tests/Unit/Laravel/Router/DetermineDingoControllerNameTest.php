...
/** @covers \Scoutapm\Laravel\Router\DetermineDingoControllerName */
final class DetermineDingoControllerNameTest extends TestCase
{
    ...
    private $router;
    /** @var DetermineDingoControllerName */
    ...
    public function setUp(): void
    {
        ...
        $this->determineControllerName = new DetermineDingoControllerName(
    ...
    public function testUnknownIsReturnedAndExceptionLoggedWhenRouterThrowsException(): void
    {
        ...
        $this->logger->expects(self::once())
            ...
            ->with(
                LogLevel::DEBUG,
                '[Scout] Exception obtaining name of Dingo endpoint: oh no'
            );

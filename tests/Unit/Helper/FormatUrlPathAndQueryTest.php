...
final class FormatUrlPathAndQueryTest extends TestCase
{
    ...
    public function urlFilteringProvider(): array
    {
        return [
            ...
            'filtered_query_last' => [ConfigKey::URI_REPORTING_FILTERED, '/path/to/thing.html?a=b&e[]=1&e[]=2&filteredParam=boo', '/path/to/thing.html?a=b&e[]=1&e[]=2'],
            'filtered_query_first' => [ConfigKey::URI_REPORTING_FILTERED, '/path/to/thing.html?filteredParam=boo&c=d&e[]=1&e[]=2', '/path/to/thing.html?c=d&e[]=1&e[]=2'],
            ...
            'filtered_query_fragment_last' => [ConfigKey::URI_REPORTING_FILTERED, '/path/to/thing.html?a=b&e[]=1&e[]=2&filteredParam=boo#fragment', '/path/to/thing.html?a=b&e[]=1&e[]=2#fragment'],
            'filtered_query_fragment_first' => [ConfigKey::URI_REPORTING_FILTERED, '/path/to/thing.html?filteredParam=boo&c=d&e[]=1&e[]=2#fragment', '/path/to/thing.html?c=d&e[]=1&e[]=2#fragment'],
